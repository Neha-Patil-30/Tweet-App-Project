...
String loginResponseJson="{\"user\":{\"id\":\"id\",\"username\":\"admin\",\"password\":\"admin\",\"email\":\"fse@gmail.com\",\"firstName\":\"admin\",\"lastName\":\"admin\",\"contactNumber\":null},\"loginStatus\":\"success\",\"token\":\"null\", \"errorMessage\":\"null\"}";
...
loginResponse1.setToken(null);
loginResponse1.setErrorMessage(null);
...
assertNotEquals(loginResponseJson, response.getContentAsString());
...
assertNotEquals(expectedJson, response.getContentAsString());
}

@Test
public void postTweetPositiveTest() throws Exception
{
String reqJson="{\"tweet\":\"desc\",\"username\":\"Luffy\"}";
...
assertNotEquals(responseJson, response.getContentAsString());
}
...
String url="/api/v1.0/tweets/user/search/admin";
List<User> user1List= new ArrayList<>();
User user1 = new User();
user1.setId("id");
user1.setEmail("fse@gmail.com");
...
when(userServiceMock.getUserByUsername("admin")).thenReturn(user1List);
MockHttpServletResponse response = mockMvc.perform(get(url).accept(MediaType.APPLICATION_JSON)).andReturn().getResponse();
System.out.println(response);
...
@Test
public void updateTweetByUserTest() throws Exception {
   String uri = "/api/v1.0/tweets/admin/update/1";
   String reqJson="{\"tweet\":\"desc\",\"username\":\"Luffy\", \"tweetId\":\"1\"}";
   Tweet userTweets1= new Tweet();
   userTweets1.setTweetName("Demo Tweet");
 
   tweetServiceMock.editTweet(userTweets1);
...
@Test
public void deleteTweetByUserTest() throws Exception {
   String uri = "/api/v1.0/tweets/admin/delete/1";
...
@Test
public void likeTweetByUserTest() throws Exception {
   String uri = "/api/v1.0/tweets/admin/like/1";
